...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference('Garden.count') do
      post gardens_url, params: { garden: { address: @garden.address, image_url: @garden.image_url, name: @garden.name } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { address: @garden.address, image_url: @garden.image_url, name: @garden.name } }
